...
ODataServer.prototype._initializeRoutes = function () {
	...
	this.router.get("/:collection\\(:id\\)/:function", function(req, res) {
        func(self.cfg, req, res);
    });
	
    this.router.get("/:collection/:function", function(req, res) {
        func(self.cfg, req, res);
    });
    ...
    this.router.post("/:collection/:function", function(req, res) {
        func(self.cfg, req, res);
    });
...
ODataServer.prototype.executeUpdate = function (col, query, update, cb) {
    ...
    this.cfg.beforeUpdate(col, query, update, function (err) {
        if (err)
            return cb(err);
		update.$set.lastModified = Date.now();
